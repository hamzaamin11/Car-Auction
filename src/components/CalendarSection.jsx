    ...
    <div className="w-full mb-6 px-6 py-6">
      <div className="w-full flex flex-col md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:space-x-8">
          <h1 className="text-4xl font-bold mb-4 md:mb-0">Auctions calendar
</h1>
      ...
      <div className="max-w-4xl mt-6 text-gray-600 text-base leading-relaxed text-justify">
        <p>
         Don’t miss an auction with the Auctions Calendar. The Auction Calendar shows you all upcoming auctions 
         planned for the week by date, time and location. Click on the location to see the vehicles listed in that 
      ...
      {showEmailForm && (
       ...
       <CalendarAuctionTable showTime={showTime} /> 
    </div>
  );
}
