...
export const Reauction = ({
  ...
  useEffect(() => {
    if (selectReauction) {
      // Assuming selectReauction has either vehicleId or vehicleName
      // Adjust based on your actual data structure
      setAssignData((prev) => ({
        ...prev,
        vehicleId: selectReauction?.id || selectReauction?.vehicleName || "",
      }));
    }
  }, [selectReauction]);
  ...
  const handleSubmitEvent = async (e) => {
    ...
    try {
      const res = await axios.post(
        `${BASE_URL}/admin/againCreateAssignedEvents`,
        assignData
      );
      console.log(res.data);
      setOpen();
