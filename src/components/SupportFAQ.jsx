...
const faqs = [
  ...
  },
  {
    ...
    a: 'You can email us at support@chuhdarycars.com, use our 24/7 live chat, or fill out the contact form below.',
  },
  {
      ...
      <div className="max-w-4xl mx-auto space-y-4">
        {faqs.map((faq, index) => (
          <div key={index} className="bg-white rounded-lg shadow-md transition hover:shadow-lg">
            ...
            >
              <span className="text-lg font-medium text-[#233d7b]">{faq.q}</span>
              {activeIndex === index ? (
