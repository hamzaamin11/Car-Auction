...
const Card = ({ icon, title, totalData, path }) => {
  return (
    ...
    >
      ...
      {/* Icon */}
      <div className="bg-white p-4 rounded-full text-blue-950 flex items-center justify-center text-3xl sm:text-4xl mb-3">
        {icon}
      </div>

      {/* Text */}
      <div className="text-center z-10">
        <h3 className="text-sm sm:text-base font-extrabold text-blue-950">
          {title}
        </h3>
