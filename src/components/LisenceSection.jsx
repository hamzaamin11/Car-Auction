...
const LisenceSection = () => {
  ...
  return (
    <div className="content-section bg-white text-gray-800" data-aos="fade-up">
      ...
      <div className="w-full flex flex-col md:flex-row items-center gap-0 mb-8 bg-[#f7fafc]">
        
      <div className="w-full md:w-1/2 flex justify-center items-center p-4">
          <img
            src="/images/lisence.avif"
            alt="Lisence"
        ...
        <h1 className="text-3xl font-bold text-gray-800">Licensing Information</h1>
      </div>
          <p className="mb-4">CHAUDHRY offers Pakistan Mainland delivery for a multitude of vehicles. Check if a lot has delivery available on the Lot Details page or Unpaid Invoices following the sale.</p>
