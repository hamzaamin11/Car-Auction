...
const handleModelSelect = (model) => {
  ...
  const bottomTabLinks = {
    "featured items": ["Featured Cars (222)", "Vehicles for Auctions (10, 387)", "High Value items (69)", "Buy it Now (719)", "New Listings (1682)", "Used Vehicles (313)", "Used Vehicles-Damaged (3340)", "Pure Sale items (6073)", "Runs ans Drives (8099)", "Fleet/Lease(2080)", "Repossessions (91)"],
    ...
    Types: ["Cars (10,531)", "Used Vehicles (368)", "Vehicles Under 7.5 Tonnes for Sale (10, 531)"],
