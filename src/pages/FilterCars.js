...
const FilterCars = () => {
  ...
  const bottomTabLinks = {
    "featured items": [
      "Featured Cars (222)",
      "Vehicles for Auctions (10, 387)",
      "High Value items (69)",
      "Buy it Now (719)",
      "New Listings (1682)",
      "Used Vehicles (313)",
      "Used Vehicles-Damaged (3340)",
      "Pure Sale items (6073)",
      "Runs ans Drives (8099)",
      "Fleet/Lease(2080)",
      "Repossessions (91)",
    ],
    make: [
    ...
    Types: [
      "Cars (10,531)",
      "Used Vehicles (368)",
      "Vehicles Under 7.5 Tonnes for Sale (10, 531)",
    ],
    "vehicle types": [
      "SUV",
      "Sedan",
    ...
    <div className="flex flex-col lg:flex-row p-8 gap-10 bg-gray-50 rounded-lg shadow-md">
      ...
      <div className="lg:w-2/3 bg-white p-6 rounded-lg shadow space-y-6">
        ...
        <p className="text-gray-600">
          Looking for vehicles in a specific condition? Simplify your search by
          selecting a category to narrow your results.
        </p>
        ...
        <h3 className="text-xl font-bold text-gray-800">
          All Used & New Vehicles
        </h3>
        <p className="text-gray-600">
          Browse our wide selection of used and New vehicles in auction daily,
          by using the Vehicle Finder on this page, or by selecting the
          categories below. New inventory arrives daily, so check back often!
        </p>
