...
const handleModelSelect = (model) => {
  ...
  const bottomTabLinks = {
    "featured items": ["Featured Cars (3)", "Vehicles for Auctions (401)", "High Value items (2)", "Buy it Now (5)", "New Listings (97)",  "Pure Sale items (3)", "Runs and Drives (401)", "Fleet/Lease(291)", "Repossessions (21)"],
    ...
    "category": ["CAT D-New (4)", "CAT U-Used Unrecorded (343)", "N Repairable Non Structural (28)", "S Repairable Structural (26)"],
        ...
        <div className="relative w-full max-w-sm">
            ...
            >
              ...
              <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLineJoin Auction="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
              </svg>
            </div>
